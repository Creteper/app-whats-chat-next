export function md5(string: string): string {
  ...
  function md5_AddUnsigned(lX: number, lY: number): number {
    const lX4: number = lX & 0x40000000, lY4: number = lY & 0x40000000, lX8: number = lX & 0x80000000, lY8: number = lY & 0x80000000, lResult: number = (lX & 0x3fffffff) + (lY & 0x3fffffff);
    if (lX4 & lY4) {
  ...
  function md5_ConvertToWordArray(string: string): Array<number> {
